    ...
    if st.button("Generate Graphs"):
        ...
        try:
            ...
            for _, row in metadata_df.iterrows():
                ...
                # Apply simple border via white background and thick grid lines for metric table
                # for row in range(rows + 1):
                #     for col in range(cols):
                #         cell = metric_table.cell(row, col)
                #         cell.fill.solid()
                #         cell.fill.fore_color.rgb = RGBColor(255, 255, 255)
                #         for line in [cell._element.tcPr.get_or_add_lnL(),
                #                      cell._element.tcPr.get_or_add_lnR(),
                #                      cell._element.tcPr.get_or_add_lnT(),
                #                      cell._element.tcPr.get_or_add_lnB()]:
                #             line.width = Pt(1.25)
