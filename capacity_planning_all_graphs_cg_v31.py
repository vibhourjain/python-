    ...
    if st.button("Generate Graphs"):
        ...
        try:
            ...
            for _, row in metadata_df.iterrows():
                ...
                # For the metric table - create a plain table with white background and black text
                ...
                # Don't apply any table style to avoid orange background
                # Instead, manually set white background and black text for each cell
